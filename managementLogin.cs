    ...
    public partial class managementLogin : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "Select * from dbo.Management Where m_id = '" + idBox.Text.Trim() + "' and m_password = '" + passwordBox.Text.Trim() + "'";
            ...
            try
            {
                SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-DCIEBGS;Initial Catalog='Hospital Management System';Integrated Security=True;");
                conn.Open();
                string query = "SELECT m_password from management where ";
                SqlCommand comand = new SqlCommand(query, conn);

                comand.Parameters.AddWithValue("@m_id", idBox.Text);
                comand.Parameters.AddWithValue("@m_password", passwordBox.Text);
